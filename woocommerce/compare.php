...
$table_text = get_option( 'yith_woocompare_table_text', esc_html__( 'Compare products', 'farmart' ) );
...
<h1>
    ...
    <?php if ( ! $is_iframe ) : ?><a class="close" href="#"><?php esc_html_e( 'Close window [X]', 'farmart' ) ?></a><?php endif; ?>
</h1>
...
<div id="yith-woocompare" class="woocommerce">
    ...
    <?php $css_class = empty( $products) ? '' : 'full-width'; ?>

    <table class="compare-list <?php echo esc_attr($css_class); ?>" cellpadding="0" cellspacing="0">
    <thead>
    <tr>
        <th>&nbsp;</th>
    ...
    <?php if ( empty( $products ) ) : ?>
        ...
        <tr class="no-products">
            <td><?php esc_html_e( 'No products added in the compare table.', 'farmart' ) ?></td>
        </tr>
    ...
    <?php else : ?>
        <?php foreach ( $fields as $field => $name ) : ?>
            ...
            <tr class="<?php echo esc_attr( $field ) ?>">
                ...
                <th>
                    <?php if ( $field != 'image' ) echo ! empty( $name ) ? $name : '' ?>
                </th>
        ...
        <?php if ( $repeat_add_to_cart == 'yes' && isset( $fields['add-to-cart'] ) ) : ?>
            <tr class="add-to-cart repeated">
                <th>
                    <?php
                        $field_ATC = $fields['add-to-cart'];
                        echo ! empty( $field_ATC ) ? $field_ATC : '';
                    ?>
                </th>
