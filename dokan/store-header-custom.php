...
if ( in_array( $profile_layout, array( 'layout3', 'fm_custom' ) ) ) {
    unset( $store_info['banner'] );

    $no_banner_class      = ' profile-frame-no-banner';
    $no_banner_class_tabs = ' hidden dokan-store-tabs-no-banner';
}
            ...
            <div class="profile-info-summery">
                <?php if ( $store_user->get_banner() ) : ?>
                    <div class="profile-info-head">
                        <div class="profile-img <?php echo esc_attr( $profile_img_class ); ?>">
                            <?php
                                $banner_id = (int) $store_user->get_info_part( 'banner' );
                                echo wp_get_attachment_image( $banner_id, 'farmart-dokan-banner' );
                            ?>
                        </div>
                ...
                <div class="profile-info">
                    <div class="profile-avatar">
                        <?php echo get_avatar( $store_user->get_id() ); ?>
                    </div>
                    ...
                    <div class="dokan-store-information">
                        ...
                        <ul class="dokan-store-info">
                            <?php if ( $store_user->get_register_date() ) { ?>
                                <li class="dokan-store-register-date">
                                    <?php
                                        $originalDate = $store_user->get_register_date();
